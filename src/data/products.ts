...
export const products: Product[] = [
  {
    ...
    image: "/Sabze/images/product-250.webp",
    imageAlt: "بسته ۲۵۰ گرمی کشمش سبز ممتاز سبزه سبز کنار کاسه کشمش",
    gallery: [
      { src: "/Sabze/images/product-250.webp", alt: "بسته ۲۵۰ گرمی کشمش سبز ممتاز" },
      { src: "/Sabze/images/grapes.webp", alt: "خوشه‌های انگور سبز روی تاک" },
      { src: "/Sabze/images/harvest.webp", alt: "برداشت انگور از باغ سبزه سبز" },
    ],
    specs: [
  ...
  },
  {
    ...
    image: "/Sabze/images/product-500.webp",
    imageAlt: "بسته ۵۰۰ گرمی کشمش سبز ممتاز سبزه سبز",
    gallery: [
      { src: "/Sabze/images/product-500.webp", alt: "بسته ۵۰۰ گرمی کشمش سبز ممتاز" },
      { src: "/Sabze/images/harvest.webp", alt: "برداشت انگور از باغ سبزه سبز" },
      { src: "/Sabze/images/garden.webp", alt: "باغ انگور سبزه سبز" },
    ],
    specs: [
  ...
  },
  {
    ...
    image: "/Sabze/images/product-1kg.webp",
    imageAlt: "بسته یک کیلویی کشمش سبز ممتاز سبزه سبز",
    gallery: [
      { src: "/Sabze/images/product-1kg.webp", alt: "بسته یک کیلویی کشمش سبز ممتاز" },
      { src: "/Sabze/images/garden.webp", alt: "باغ انگور سبزه سبز" },
      { src: "/Sabze/images/grapes.webp", alt: "خوشه‌های انگور سبز روی تاک" },
    ],
    specs: [
  ...
  },
  {
    ...
    image: "/Sabze/images/product-2kg.webp",
    imageAlt: "بسته دو کیلویی کشمش سبز ویژه سبزه سبز",
    gallery: [
      { src: "/Sabze/images/product-2kg.webp", alt: "بسته دو کیلویی کشمش سبز ویژه" },
      { src: "/Sabze/images/harvest.webp", alt: "برداشت انگور از باغ سبزه سبز" },
      { src: "/Sabze/images/garden.webp", alt: "باغ انگور سبزه سبز" },
    ],
    specs: [
  ...
  },
  {
    ...
    image: "/Sabze/images/product-gift.webp",
    imageAlt: "جعبه هدیه نفیس کشمش سبز سبزه سبز با روبان",
    gallery: [
      { src: "/Sabze/images/product-gift.webp", alt: "جعبه هدیه نفیس کشمش سبز" },
      { src: "/Sabze/images/grapes.webp", alt: "خوشه‌های انگور سبز روی تاک" },
      { src: "/Sabze/images/garden.webp", alt: "باغ انگور سبزه سبز" },
    ],
    specs: [
  ...
  },
  {
    ...
    image: "/Sabze/images/product-5kg.webp",
    imageAlt: "بسته پنج کیلویی اقتصادی کشمش سبز سبزه سبز",
    gallery: [
      { src: "/Sabze/images/product-5kg.webp", alt: "بسته پنج کیلویی اقتصادی کشمش سبز" },
      { src: "/Sabze/images/garden.webp", alt: "باغ انگور سبزه سبز" },
      { src: "/Sabze/images/harvest.webp", alt: "برداشت انگور از باغ سبزه سبز" },
    ],
    specs: [
